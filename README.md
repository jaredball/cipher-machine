This project implements a cipher-machine in C, allowing users to encrypt or decrypt codes, encode strings, and represent numbers in unary code. The program supports the following commands:
